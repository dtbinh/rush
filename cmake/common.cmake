...
macro(rb_library LIB_NAME )
    ...
    if(WIN32)
        ...
        set(LIB_FILES ${LIB_FILES} ${WIN32_HEADER_FILES} ${WIN32_SOURCE_FILES})
    endif(WIN32)
...
macro(rb_add_tests SOURCE_FILES LIB_NAME)
    file(GLOB TEST_HEADER_FILES "${ENGINE_SRC_DIR}/${LIB_NAME}/test/*.h") 
    set_source_files_properties(${TEST_HEADER_FILES} PROPERTIES HEADER_FILE_ONLY 1)
    file(GLOB TEST_SOURCE_FILES "${ENGINE_SRC_DIR}/${LIB_NAME}/test/*.cpp") 
    source_group(tests\\${LIB_NAME} FILES ${TEST_HEADER_FILES} ${TEST_SOURCE_FILES})
    set(SOURCE_FILES ${SOURCE_FILES} ${TEST_HEADER_FILES} ${TEST_SOURCE_FILES})
